...
import { DbMutexesRow, DbTasksRow, DB_TASKS_TABLE } from '../database/tables';
 ...
 */
export class TaskManagerJanitor {
  ...
  private async runOnce() {
    ...
    const mutexesQuery = this.knex<DbMutexesRow>(
      'backstage_backend_common__mutexes',
    )
